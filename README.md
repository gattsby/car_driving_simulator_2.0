# Car Driving Simulator 2.0
This expands on an earlier project I worked on but involves manipulating strings in order to get different outputs.
...
public class DrivingSimulationLab {
    ...
    public static void accelerate() {
        ...
        if (isEngineOn && !gear.equals("P")) {
            ...
            System.out.println("Error. Cannot accelerate if engine is off or the selected gear is P.");
    ...
    public static void brake() {
        ...
        speed -= 5;
            ...
            System.out.println("Error. Cannot apply brake is the engine is off or the car is not moving.");
